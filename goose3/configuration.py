...
class Configuration:
    ...
    @property
    def preserve_elements(self) -> bool:
        """bool: Enable preservation of specific HTML elements in the body content
        
        Note:
            Defaults to `False`"""
        return self._preserve_elements

    @preserve_elements.setter
    def preserve_elements(self, val: bool):
        """set the preserve_elements property"""
        self._preserve_elements = bool(val)
